module github.com/sapslaj/valkey-leader

go 1.25.0

require (
	github.com/valkey-io/valkey-go v1.0.64
	github.com/yokecd/yoke v0.16.7
	k8s.io/api v0.34.1
...
require (
	...
	github.com/davidmdm/x/xruntime v0.0.5 // indirect
	...
	github.com/yokecd/lipgloss v1.0.2 // indirect
...
tool (
	...
	github.com/yokecd/yoke/cmd/yoke
)
